...
describe('updateTask', () => {
  test('updates the sortOrder without changing updatedAt or making a history item', async () => {
    ...
    await updateTask.resolve(undefined, {updatedTask}, {authToken, getDataLoader, socket});
  ...
  test('throw when the caller is not a team member', async () => {
    ...
    await expectAsyncToThrow(updateTask.resolve(undefined, {updatedTask}, {authToken, getDataLoader, socket}),
